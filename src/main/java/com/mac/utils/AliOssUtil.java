...
public class AliOssUtil {
    ...
    private static String accessKeyId = "LTAI4FtKpZcPcZ4gGTxv9Kid";
    private static String accessKeySecret = "bXeS1l5cGbeuIg6eTneOheuFNbx2Ej";
    private static String bucketName = "mymac-goods";
